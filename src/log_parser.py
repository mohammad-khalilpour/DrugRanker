...
def main():
    exp_dir = Path("/media/external_16TB_1/kian_khalilpour/DrugRanker/expts/result_pg_updated/")
    setup = "LCO"
    ds_name = "ctrp"
    ...
    plt.savefig(save_dir / "lambdaloss_loss_0.png", dpi=300)
    plt.close()
    ...
    save_dir.mkdir(parents=True, exist_ok=True)
    plt.savefig(save_dir / "lambdaloss_gnorm_0.png", dpi=300)
    plt.close()
